...
$arComponentParameters = array(
	"GROUPS" => array(
		"SEF" => array(
			"NAME" => GetMessage("KIT_CMP_FILTER_GROUP_SEF"),
		),
		"FIELDS" => array(
			"NAME" => GetMessage("KIT_CMP_FILTER_GROUP_FIELDS"),
		),
		"PRICES" => array(
			"NAME" => GetMessage("KIT_CMP_FILTER_GROUP_PRICES"),
		),
		"STORES" => array(
			"NAME" => GetMessage("KIT_CMP_FILTER_GROUP_STORES"),
		),
		"XML_EXPORT" => array(
			"NAME" => GetMessage("KIT_CMP_FILTER_GROUP_XML_EXPORT"),
		),
	),
	"PARAMETERS" => array(
		"IBLOCK_TYPE" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("KIT_CMP_FILTER_IBLOCK_TYPE"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "Y",
			"VALUES" => $arIBlockType,
			"REFRESH" => "Y",
		...
		"IBLOCK_ID" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("KIT_CMP_FILTER_IBLOCK_ID"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "Y",
			"VALUES" => $arIBlock,
			"REFRESH" => "Y",
		...
		"FILTER_NAME" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("KIT_CMP_FILTER_FILTER_NAME"),
			"TYPE" => "STRING",
			"DEFAULT" => "arrFilter",
		),
		"PRICE_CODE" => array(
			"PARENT" => "PRICES",
			"NAME" => GetMessage("KIT_CMP_FILTER_PRICE_CODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"VALUES" => $arPrice,
		),
		...
		"CACHE_GROUPS" => array(
			...
			"NAME" => GetMessage("KIT_CMP_FILTER_CACHE_GROUPS"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"SAVE_IN_SESSION" => array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("KIT_CMP_FILTER_SAVE_IN_SESSION"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"INCLUDE_JQUERY" => array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("KIT_CMP_FILTER_INCLUDE_JQUERY"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"CLOSED_PROPERTY_CODE" => array(
			"PARENT" => "FIELDS",
			"NAME" => GetMessage("KIT_CMP_FILTER_CLOSED_PROPERTY_CODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"VALUES" => $arProperty,
			"ADDITIONAL_VALUES" => "Y",
		...
		"CLOSED_OFFERS_PROPERTY_CODE" => array(
			"PARENT" => "FIELDS",
			"NAME" => GetMessage("KIT_CMP_FILTER_CLOSED_OFFERS_PROPERTY_CODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
		...
		"SORT" => array(
			"PARENT" => "FIELDS",
			"NAME" => GetMessage("KIT_CMP_FILTER_SORT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
		),
		"XML_EXPORT" => array(
			"PARENT" => "XML_EXPORT",
			"NAME" => GetMessage("KIT_CMP_FILTER_XML_EXPORT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
		),
		"PAGE_URL" => array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME"=>GetMessage("KIT_CMP_FILTER_PAGE_URL"),
			"TYPE"=>"STRING",
			"DEFAULT"=>"",
		),
		"IS_SEF" => array(
			"PARENT" => "SEF",
			"NAME" => GetMessage("KIT_CMP_FILTER_IS_SEF"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
		),
		"MESSAGE_ALIGN" => array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("KIT_CMP_FILTER_MESSAGE_ALIGN"),
			"TYPE" => "LIST",
			"VALUES" => array(
				"LEFT" => GetMessage("KIT_CMP_FILTER_MESSAGE_ALIGN_LEFT"),
				"RIGHT" => GetMessage("KIT_CMP_FILTER_MESSAGE_ALIGN_RIGHT"),
			),
			"DEFAULT" => "LEFT"
		),
		"MESSAGE_TIME" => array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("KIT_CMP_FILTER_MESSAGE_TIME"),
			"TYPE" => "STRING",
			"DEFAULT" => '5',
		)
	),
...
if (isset($arCurrentValues['IS_SEF']) && 'Y' == $arCurrentValues['IS_SEF'])
{
	$arComponentParameters['PARAMETERS']['SEF_BASE_URL'] = array(
		"PARENT" => "SEF",
		"NAME"=>GetMessage("KIT_CMP_FILTER_SEF_BASE_URL"),
		"TYPE"=>"STRING",
		"DEFAULT"=>'/catalog/',
	);
	...
	$arComponentParameters['PARAMETERS']['SECTION_PAGE_URL'] = CIBlockParameters::GetPathTemplateParam(
		"SECTION",
		"SECTION_PAGE_URL",
		GetMessage("KIT_CMP_FILTER_SECTION_PAGE_URL"),
		"#SECTION_ID#/",
		"SEF"
	);
	...
	$arComponentParameters['PARAMETERS']['DETAIL_PAGE_URL'] = CIBlockParameters::GetPathTemplateParam(
		"DETAIL",
		"DETAIL_PAGE_URL",
		GetMessage("KIT_CMP_FILTER_DETAIL_PAGE_URL"),
...
else
{
	$arComponentParameters['PARAMETERS']['SECTION_ID'] = array(
		"PARENT" => "DATA_SOURCE",
		"NAME" => GetMessage("KIT_CMP_FILTER_SECTION_ID"),
		"TYPE" => "STRING",
	...
	$arComponentParameters['PARAMETERS']['SECTION_CODE'] = array(
		"PARENT" => "DATA_SOURCE",
		"NAME" => GetMessage("KIT_CMP_FILTER_SECTION_CODE"),
		"TYPE" => "STRING",
		"DEFAULT" => '',
	);
}
...
if (isset($arCurrentValues['XML_EXPORT']) && 'Y' == $arCurrentValues['XML_EXPORT'])
{
	$arComponentParameters['PARAMETERS']['SECTION_TITLE'] = array(
		"PARENT" => "XML_EXPORT",
		"NAME" => GetMessage("KIT_CMP_FILTER_SECTION_TITLE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"DEFAULT" => "-",
		"VALUES" => array_merge(
	...
	$arComponentParameters['PARAMETERS']['SECTION_DESCRIPTION'] = array(
		"PARENT" => "XML_EXPORT",
		"NAME" => GetMessage("KIT_CMP_FILTER_SECTION_DESCRIPTION"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"DEFAULT" => "-",
		"VALUES" => array_merge(
...
$arFields = array(
	'SECTIONS' => GetMessage('KIT_CMP_FILTER_FIELDS_SECTIONS')
);
...
if ($boolCatalog)
{
	...
	$arComponentParameters["PARAMETERS"]['HIDE_NOT_AVAILABLE'] = array(
		'PARENT' => 'STORES',
		'NAME' => GetMessage('KIT_CMP_FILTER_HIDE_NOT_AVAILABLE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
	);
	...
	if(count($arStores))
	{
		$arComponentParameters['PARAMETERS']['STORES_ID'] = array(
			'PARENT' => 'STORES',
			'NAME' => GetMessage('KIT_CMP_FILTER_STORES_ID'),
			'TYPE' => 'LIST',
			'DEFAULT' => '',
			"MULTIPLE" => "Y",
			"VALUES" => $arStores
	...
	if (CModule::IncludeModule('currency'))
	{
		$arComponentParameters["PARAMETERS"]['CONVERT_CURRENCY'] = array(
			'PARENT' => 'PRICES',
			'NAME' => GetMessage('KIT_CMP_FILTER_CONVERT_CURRENCY'),
			'TYPE' => 'CHECKBOX',
			'DEFAULT' => 'N',
			'REFRESH' => 'Y',
		);
		...
		if (isset($arCurrentValues['CONVERT_CURRENCY']) && 'Y' == $arCurrentValues['CONVERT_CURRENCY'])
		{
			...
			$arComponentParameters['PARAMETERS']['CURRENCY_ID'] = array(
				'PARENT' => 'PRICES',
				'NAME' => GetMessage('KIT_CMP_FILTER_CURRENCY_ID'),
				'TYPE' => 'LIST',
	...
	$arFields['STORES'] = GetMessage('KIT_CMP_FILTER_FIELDS_STORES');
	$arFields['QUANTITY'] = GetMessage('KIT_CMP_FILTER_FIELDS_QUANTITY');
	
	if($arCurrentValues['HIDE_NOT_AVAILABLE'] !== 'Y')
	{
		$arFields['AVAILABLE'] = GetMessage('KIT_CMP_FILTER_FIELDS_AVAILABLE');
	}
}
...
if(isset($arCurrentValues['SORT']) && 'Y' == $arCurrentValues['SORT'])
{
	$arComponentParameters['PARAMETERS']['SORT_ORDER'] = array(
		"PARENT" => "FIELDS",
		"NAME" => GetMessage("KIT_CMP_FILTER_SORT_ORDER"),
		"TYPE" => "LIST",
		"DEFAULT" => "ASC",
		"VALUES" => array(
			"ASC" => GetMessage("KIT_CMP_FILTER_SORT_ORDER_ASC"),
			"DESC" => GetMessage("KIT_CMP_FILTER_SORT_ORDER_DESC")
		)
	);
}
...
$arComponentParameters["PARAMETERS"]['FIELDS'] = array(
	'PARENT' => 'FIELDS',
	'NAME' => GetMessage('KIT_CMP_FILTER_FIELDS'),
	'TYPE' => 'LIST',
	'DEFAULT' => '',
	"MULTIPLE" => "Y",
	"VALUES" => $arFields,
	...
	foreach($arCurrentValues['FIELDS'] as $field)
	{
		if(isset($arCurrentValues['SORT']) && 'Y' == $arCurrentValues['SORT'])
		{
			if(in_array($field, $arCurrentValues['FIELDS']) && isset($arFields[$field]))
			{
				$arComponentParameters['PARAMETERS']['SORT_'.$field] = array(
					'PARENT' => 'FIELDS',
					'NAME' => GetMessage('KIT_CMP_FILTER_SORT_'.$field),
					'TYPE' => 'STRING',
					'DEFAULT' => ++$sort*10
				);
			}
		...
		if($field == 'SECTIONS')
		{
			$arComponentParameters['PARAMETERS']['TOP_DEPTH_LEVEL'] = array(
				'PARENT' => 'FIELDS',
				'NAME' => GetMessage('KIT_CMP_FILTER_TOP_DEPTH_LEVEL'),
				'TYPE' => 'STRING',
				'DEFAULT' => '0'
			);
		}
