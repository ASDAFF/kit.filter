		...
		switch($arItem['SETTINGS']['VIEW'])
		{
			...
			?>
				<div class="lvl1 ye_price" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>">
					<div class="kit-filter-property-body kit-num" data-name="<?=$arItem["CODE_ALT"]?>">
						<div class="ye_price_left">
							<span class="ye_tit">
								<?=$arItem["NAME"]?><?if(strlen($arItem['HINT'])):?><span class="kit-filter-property-hint"></span><div class="kit-filter-property-hint-text"><?echo $arItem['HINT']?></div><?endif;?>:
							</span>
