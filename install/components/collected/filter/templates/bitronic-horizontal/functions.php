		...
		switch($arItem['SETTINGS']['VIEW'])
		{
			...
			?>
				<div class="lvl1 ye_price" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>">
					<div class="collected-filter-property-body collected-num" data-name="<?=$arItem["CODE_ALT"]?>">
						<div class="ye_price_left">
							<span class="ye_tit">
								<?=$arItem["NAME"]?><?if(strlen($arItem['HINT'])):?><span class="collected-filter-property-hint"></span><div class="collected-filter-property-hint-text"><?echo $arItem['HINT']?></div><?endif;?>:
							</span>
