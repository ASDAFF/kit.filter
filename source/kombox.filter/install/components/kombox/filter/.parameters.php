...
$arComponentParameters = array(
	"GROUPS" => array(
		"SEF" => array(
			"NAME" => GetMessage("KOMBOX_CMP_FILTER_GROUP_SEF"),
		),
		"FIELDS" => array(
			"NAME" => GetMessage("KOMBOX_CMP_FILTER_GROUP_FIELDS"),
		),
		"PRICES" => array(
			"NAME" => GetMessage("KOMBOX_CMP_FILTER_GROUP_PRICES"),
		),
		"STORES" => array(
			"NAME" => GetMessage("KOMBOX_CMP_FILTER_GROUP_STORES"),
		),
		"XML_EXPORT" => array(
...
if (isset($arCurrentValues['IS_SEF']) && 'Y' == $arCurrentValues['IS_SEF'])
{
	...
	$arComponentParameters['PARAMETERS']['DETAIL_PAGE_URL'] = CIBlockParameters::GetPathTemplateParam(
		"DETAIL",
		"DETAIL_PAGE_URL",
		GetMessage("KOMBOX_CMP_FILTER_DETAIL_PAGE_URL"),
...
if ($boolCatalog)
{
	...
	{
		$arFields['AVAILABLE'] = GetMessage('KOMBOX_CMP_FILTER_FIELDS_AVAILABLE');
	}
}
